    ...
    <>
      <div className="col-3">
        <form onSubmit={(event) => handleSubmit(event)}>
          ...
          <button type="submit" className="btn btn-outline-primary w-20">
            Make Reservation
          </button>
        </form>
      </div>
...
function PropertyDetail() {
  const currentUserId = parseInt(localStorage.getItem("userid"));
  const [defaultAvatar, setDefaultAvatar] = useState("https://camo.githubusercontent.com/eb6a385e0a1f0f787d72c0b0e0275bc4516a261b96a749f1cd1aa4cb8736daba/68747470733a2f2f612e736c61636b2d656467652e636f6d2f64663130642f696d672f617661746172732f6176615f303032322d3531322e706e67")
  const { prop } = useContext(PropertyDetailContext);
          ...
          <div className="card-body">
            <div className="d-flex">
              ...
              <Link to={`/accounts/profile/${prop.host}`}>
                <img
                  src={prop.host_avatar === null ? defaultAvatar : prop.host_avatar}
